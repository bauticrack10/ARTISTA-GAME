...
function runAutomatedVerificationTests() {
  ...
  const leadSingleHit: Song = {
    ...
    peakPosition: { Global: 1, Argentina: 1, USA: 5, LatinAmerica: 1, Europe: 8, Spain: 1, Mexico: 1, UK: 3, Brazil: 2, Asia: 10, Africa: 15 },
    weeksOnChart: { Global: 8, Argentina: 8, USA: 6, LatinAmerica: 8, Europe: 5, Spain: 8, Mexico: 8, UK: 5, Brazil: 6, Asia: 2, Africa: 1 },
  ...
  const secondaryAlbumTrack: Song = {
    ...
    peakPosition: { Global: null, Argentina: 28, USA: null, LatinAmerica: 35, Europe: null, Spain: 40, Mexico: 30, UK: null, Brazil: null, Asia: null, Africa: null },
    weeksOnChart: { Global: 0, Argentina: 2, USA: 0, LatinAmerica: 1, Europe: 0, Spain: 1, Mexico: 1, UK: 0, Brazil: 0, Asia: 0, Africa: 0 },
    longevityCurve: 'steady',
    isSingle: false,
  ...
  const megaSmashSong: Song = {
    ...
    peakPosition: { Global: 1, Argentina: 1, USA: 1, LatinAmerica: 1, Europe: 1, Spain: 1, Mexico: 1, UK: 1, Brazil: 1, Asia: 1, Africa: 1 },
    weeksOnChart: { Global: 12, Argentina: 12, USA: 10, LatinAmerica: 12, Europe: 10, Spain: 12, Mexico: 12, UK: 10, Brazil: 10, Asia: 8, Africa: 8 },
    longevityCurve: 'instant_classic',
    isSingle: true,
    receptionRating: 5,
    isClassic: true,
