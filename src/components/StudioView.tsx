...
export const StudioView: React.FC<StudioViewProps> = ({
  ...
  return (
    <div className="space-y-8 pb-16 font-sans text-[#1c1c1c]">
      {/* --- HEADER: WARM NOTEPAD EDITORIAL VIBE --- */}
      <div className="bg-[#f7f4ed] border border-[#eceae4] rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-1.5 max-w-2xl">
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[rgba(28,28,28,0.04)] border border-[#eceae4] text-[#1c1c1c]">
      ...
      {/* --- NOTIFICATION TOAST --- */}
      {notification && (
        <div className="bg-[#f7f4ed] border border-[#1c1c1c]/20 text-[#1c1c1c] p-4 rounded-xl flex items-center gap-3 text-sm font-semibold shadow-[rgba(0,0,0,0.05)_0px_4px_12px] animate-fade-in">
          <CheckCircle2 className="w-5 h-5 text-[#1c1c1c]" />
          <span>{notification}</span>
        </div>
      )}

      {/* --- SONIC IDENTITY & CURRENT ERA BAR --- */}
      <div className="bg-[#f7f4ed] border border-[#eceae4] rounded-2xl p-6 space-y-4">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#eceae4] pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-[#1c1c1c] text-[#fcfbf8] flex items-center justify-center font-bold text-sm shadow-[rgba(255,255,255,0.2)_0px_0.5px_0px_0px_inset,rgba(0,0,0,0.2)_0px_0px_0px_0.5px_inset]">
          ...
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[#1c1c1c] text-[#fcfbf8]">
              Género Anclado: {styleDerivation.primaryGenreName}
            </span>
            <span className="px-3 py-1 rounded-full text-xs font-semibold border border-[#eceae4] bg-[#f7f4ed] text-[#5f5f5d]">
              {player.careerStage}
            </span>
          </div>
        </div>
        ...
        <p className="text-xs text-[#5f5f5d] leading-relaxed">
          <Info className="w-3.5 h-3.5 inline mr-1 text-[#1c1c1c]" />
      ...
      {activeTab === 'single' && (
        <form onSubmit={handleCreateSingle} className="bg-[#f7f4ed] border border-[#eceae4] rounded-2xl p-6 sm:p-8 space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#eceae4] pb-4">
            <div>
              <h2 className="text-xl font-semibold tracking-tight text-[#1c1c1c] flex items-center gap-2">
                <Mic className="w-5 h-5 text-[#1c1c1c]" />
            ...
            <div className={`px-4 py-2 rounded-xl border text-xs font-semibold flex items-center gap-2 ${
              isSinglesLimitReached
                ...
                : 'bg-[#eceae4]/40 border-[#eceae4] text-[#1c1c1c]'
            }`}>
              <Calendar className="w-4 h-4 text-[#5f5f5d]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-xs text-[#5f5f5d] hover:text-[#1c1c1c] underline font-medium cursor-pointer"
                  >
                    Sugerir Título
                  </button>
                </div>
                <input
                  ...
                  className="w-full bg-[#f7f4ed] border border-[#eceae4] focus:border-[rgba(28,28,28,0.4)] rounded-[6px] px-4 py-2.5 text-sm text-[#1c1c1c] placeholder-[#5f5f5d] focus:outline-none transition-colors"
                />
              </div>
                      ...
                      <div
                        ...
                        className={`p-3.5 rounded-xl border transition-all ${
                          !style.isUnlocked
                            ...
                            : isSelected
                            ? 'bg-[#1c1c1c] text-[#fcfbf8] border-[#1c1c1c] shadow-sm cursor-pointer'
                            : 'bg-[#f7f4ed] hover:bg-[#eceae4]/30 border-[#eceae4] text-[#1c1c1c] cursor-pointer'
                        }`}
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {style.isUnlocked ? (
                            <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full ${
                              isSelected ? 'bg-[#fcfbf8]/20 text-[#fcfbf8]' : 'bg-[#eceae4] text-[#5f5f5d]'
                            }`}>
                              Desbloqueado
                            </span>
                          ) : (
                        ...
                        <p className={`text-[11px] mt-1 leading-snug ${isSelected ? 'text-[#fcfbf8]/80' : 'text-[#5f5f5d]'}`}>
                          {style.description}
                        </p>
                      </div>
                    );
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#f7f4ed] border border-[#eceae4] focus:border-[rgba(28,28,28,0.4)] rounded-[6px] px-3.5 py-2.5 text-xs text-[#1c1c1c] focus:outline-none transition-colors cursor-pointer"
                >
            ...
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div className="bg-[#f7f4ed] p-4 rounded-xl border border-[#eceae4]">
                  <span className="block text-[11px] font-semibold text-[#5f5f5d] mb-1">
                    Producción & Mezcla
                  </span>
                  <div className="text-sm font-semibold font-mono text-[#1c1c1c] mb-2">
              ...
              {/* Cost & Summary Card */}
              <div className="bg-[#f7f4ed] p-4 rounded-xl border border-[#eceae4] space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between text-[#5f5f5d]">
                  ...
                  <span className="font-semibold text-[#1c1c1c]">-15% Energía</span>
                </div>
                <div className="flex items-center justify-between text-[#5f5f5d]">
      ...
      {activeTab === 'album' && (
        <form onSubmit={handleCreateAlbum} className="bg-[#f7f4ed] border border-[#eceae4] rounded-2xl p-6 sm:p-8 space-y-6">
          <div className="border-b border-[#eceae4] pb-4">
            <h2 className="text-xl font-semibold tracking-tight text-[#1c1c1c] flex items-center gap-2">
              <Layers className="w-5 h-5 text-[#1c1c1c]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#f7f4ed] p-4 rounded-xl border border-[#eceae4] space-y-3">
                <div className="flex items-center justify-between">
                  <label className="block text-xs font-semibold uppercase tracking-wider text-[#1c1c1c]">
                        ...
                        <div
                          ...
                          className={`p-2.5 rounded-lg border flex items-center justify-between text-xs cursor-pointer transition-all ${
                            isChecked
                              ...
                              : 'bg-[#f7f4ed] hover:bg-[#eceae4]/40 border-[#eceae4] text-[#1c1c1c]'
                          }`}
                        >
                          <div className="flex items-center gap-2">
                            {isChecked ? (
                          ...
                          <span className={`text-[11px] font-mono ${isChecked ? 'text-[#fcfbf8]/80' : 'text-[#5f5f5d]'}`}>
            ...
            <div className="space-y-5">
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-[#1c1c1c] hover:underline flex items-center gap-1 cursor-pointer"
                  >
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                  ...
                  {includedSingleIds.map((sId, i) => {
                    ...
                    return (
                      <div key={sId} className="flex items-center gap-2 bg-[#eceae4]/40 px-3 py-2 rounded-[6px] border border-[#eceae4] text-xs">
                        <span className="font-mono text-xs text-[#5f5f5d] w-6">{i + 1}.</span>
                        <span className="font-semibold text-[#1c1c1c] flex-1">{single?.title || sId}</span>
                        <span className="text-[10px] uppercase font-semibold bg-[#1c1c1c] text-[#fcfbf8] px-2 py-0.5 rounded-full">
                          Single Previo
                        </span>
                      </div>
                    );
                    ...
                    return (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="flex-1 bg-[#f7f4ed] border border-[#eceae4] focus:border-[rgba(28,28,28,0.4)] rounded-[6px] px-3 py-1.5 text-xs text-[#1c1c1c] focus:outline-none"
                        />
              ...
              <div className="bg-[#f7f4ed] p-4 rounded-xl border border-[#eceae4] space-y-2 text-xs">
                ...
                <div className="flex items-center justify-between text-[#5f5f5d]">
                  <span>Consumo de Energía:</span>
                  <span className="font-semibold text-[#1c1c1c]">-35% Energía</span>
                </div>
                <div className="flex items-center justify-between text-[#5f5f5d]">
                  <span>Estimación Crítica:</span>
                  <span className="font-semibold text-[#1c1c1c]">Metacritic / Pitchfork Review</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'catalog' && (
        <div className="bg-[#f7f4ed] border border-[#eceae4] rounded-2xl p-6 sm:p-8 space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#eceae4] pb-4">
            <div>
              <h2 className="text-xl font-semibold tracking-tight text-[#1c1c1c] flex items-center gap-2">
                <Music2 className="w-5 h-5 text-[#1c1c1c]" />
              ...
              {playerAlbums.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {playerAlbums.map(album => (
                    <div
                      key={album.id}
                      className="bg-[#f7f4ed] border border-[#eceae4] rounded-xl p-5 space-y-4 shadow-sm"
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="space-y-1">
                          <span className="px-2.5 py-0.5 rounded-full text-[10px] font-semibold bg-[#1c1c1c] text-[#fcfbf8] uppercase">
                            {album.type}
                          </span>
                          <h4 className="text-base font-semibold text-[#1c1c1c] tracking-tight pt-1">
                            {album.title}
                          </h4>
                        ...
                        <div className="text-right">
                          ...
                          <span className="font-mono font-semibold text-sm text-[#1c1c1c]">
                      ...
                      <div className="bg-[#eceae4]/30 border border-[#eceae4] p-3 rounded-lg space-y-1 text-xs">
                        <div className="flex items-center justify-between">
                          <span className="font-semibold text-[#1c1c1c] flex items-center gap-1.5">
                            <Award className="w-3.5 h-3.5 text-[#1c1c1c]" />
                            Puntaje Crítico:
                          </span>
                          <span className="font-mono font-semibold text-xs px-2 py-0.5 rounded bg-[#1c1c1c] text-[#fcfbf8]">
          ...
          {(catalogFilter === 'all' || catalogFilter === 'singles') && (
            <div className="space-y-4 pt-4 border-t border-[#eceae4]">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-[#5f5f5d] flex items-center gap-1.5">
                <Disc3 className="w-4 h-4 text-[#1c1c1c]" />
                ...
                <div className="space-y-3">
                  {playerSongs.map(song => {
                    ...
                    return (
                      <div
                        key={song.id}
                        className="bg-[#f7f4ed] border border-[#eceae4] p-4 rounded-xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm"
                      >
                        <div className="space-y-1">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {subgenre && (
                              <span className="text-[10px] font-semibold bg-[#eceae4] text-[#1c1c1c] px-2 py-0.5 rounded-full">
                                {subgenre.name}
                              </span>
                            )}
                            {song.wentViral && (
                              <span className="text-[10px] font-semibold bg-[#1c1c1c] text-[#fcfbf8] px-2 py-0.5 rounded-full">
                                Viral Hit
                              </span>
                            )}
                            {song.isClassic && (
                              <span className="text-[10px] font-semibold border border-[#1c1c1c] text-[#1c1c1c] px-2 py-0.5 rounded-full">
                                Clásico
                              </span>
                            )}
                          </div>
                          ...
                          <p className="text-xs text-[#5f5f5d]">
                            Lanzado: {song.releaseYear} • Calidad: {song.quality}% • Comercial: {song.commercialAppeal}%
                          </p>
                        </div>

                        <div className="flex items-center gap-6 text-xs font-mono">
                          <div>
                            <span className="text-[#5f5f5d] block text-[10px]">Peak Global</span>
                          ...
                          <div>
                            <span className="text-[#5f5f5d] block text-[10px]">Streams / Mes</span>
                            <span className="font-semibold text-sm text-[#1c1c1c]">
                          ...
                          <div>
                            <span className="text-[#5f5f5d] block text-[10px]">Total Acumulado</span>
                            <span className="font-semibold text-sm text-[#1c1c1c]">
